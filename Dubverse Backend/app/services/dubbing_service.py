...
class DubbingService:
        ...
        try:
            ...
            for i, segment in enumerate(transcript):
                ...
                audio_segments.append({
                    ...
                    "translation_flagged": segment.get("translation_flagged"),
                    "flag_reason": segment.get("flag_reason"),
                    "flags": _flags,
            ...
            iteration = 0
            # translation_flagged segments get no audio but their text must still
            # reach segments.json (editor review). Keep them out of audio_segments
            # (mixdown reads seg["path"]) and merge them into the payload here.
            ...
            while True:
                ...
                async with lock:
                    ...
                    payload = await asyncio.to_thread(
                        ...
                        job_id, target_norm, _segments_for_json, output_dir, scenes,
    ...
    def _write_segments_json_locked(
        ...
        """Write segments.json. Caller must hold the per-job lock; returns the payload."""
        path = os.path.join(output_dir, "segments.json")
    ...
    async def regenerate_segment(
        ...
        _explicit_text = bool(text and text.strip())
        try:
            ...
            if _window > 0.2 and not _explicit_text and _pred > _window * 1.15:
                from app.services.adaptation_engine import adapt_batch
