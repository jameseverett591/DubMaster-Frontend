...
_CJK_SHARED: Dict[str, str] = {
    ...
    "金師父": "Master Jin",
    "金师父": "Master Jin",
    "甘師傅": "Master Jin",    # Whisper: 甘 for 金 (homophones in Cantonese)
    "甘师傅": "Master Jin",
    "甘師父": "Master Jin",
    "甘师父": "Master Jin",
    "甘師":   "Master Jin",
...
_GLOSSARY_YUE: Dict[str, str] = {
    **_CJK_SHARED,
    ...
    # Line 15 — Mrs. Ip: yells at Master Jin ("Shut your mouth!"), then turns
    ...
    # ── Master Jin wellness checks (many Whisper script-mix variants) ──────
    ...
    "不是南北拳的問題": "It's not about Northern or Southern Fist",
    "不是南北權的問題": "It's not about Northern or Southern Fist",
    "點下金師父": "Master Jin, was my kung fu any good?",
    "點下金師傅": "Master Jin, was my kung fu any good?",
